...
const getUser = asyncHandler(async (req, res, next) => {
  ...
  if (!user) throw createError(404, `User is not found with id of ${req.params.id}`);
...
const updateUser = asyncHandler(async (req, res, next) => {
  ...
  if (!editUser) throw createError(404, `User is not found with id of ${req.params.id}`);
...
const deleteUser = asyncHandler(async (req, res, next) => {
  ...
  if (!deleteUser) throw createError(404, `User is not found with id of ${req.params.id}`);
